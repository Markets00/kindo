...
defineEntity frisbee, #0x0027, #0x0054, #16, #4, #0x10FF, #0000, #0000, #0100, #0x0100, #1, _sp_frisbee_0, #0
	frisbee_effect: .dw #0xF8FF									;; effect

defineEntity init, #0x0027, #0x0054, #16, #4, #0x10FF, #0000, #0000, #0000, #0x0100, #1, _sp_frisbee_0, #0
