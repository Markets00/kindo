...
PALETTE=12 0 1 3 4 5 6 7 10 11 13 14 18 19 24 26
...
$(eval $(call IMG2SP, SET_PALETTE_FW, $(PALETTE)))
# $(eval $(call IMG2SP, CONVERT_PALETTE, $(PALETTE), sp_palette))
$(eval $(call IMG2SP, CONVERT, assets/frisbee_1.png, 8, 16, sp_frisbee, sp_palette))
$(eval $(call IMG2SP, CONVERT, assets/robot_1.png, 10, 20, sp_player,))
$(eval $(call IMG2SP, CONVERT, assets/robot_2.png, 10, 20, sp_enemy,))
