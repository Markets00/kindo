...
Hexadecimal [16-Bits]
                             ...
                             72 
   0542 CD 49 05      [17]   73 	call 	initializeGame
                             74 	;; Configuration staff...
                             75 	;; Configuration staff...
                             76 	;; Configuration staff...
   0545 CD 4D 05      [17]   77 	call 	game_loop
   0548 C9            [10]   78 	ret
                             79 
                             80 
                             81 ;; ====================================
                             ...
                             89 ;; Initialize game
                             90 ;; ========================
   0549                      91 initializeGame:
   0549 CD 99 05      [17]   92 	call cpct_disableFirmware_asm
                             93 
                             94 	;; Set video mode
                             95 	;; ld 	c, #0
   ...
   054D CD 84 05      [17]  112 	call cpct_waitVSYNC_asm
                            113 
                            114 	;; Erase entities
   0550 CD C5 03      [17]  115 	call player_erase
   0553 CD CE 02      [17]  116 	call frisbee_erase
...
Hexadecimal [16-Bits]
                            ...
                            117 
                            118 	;; Update entities
   0556 CD D4 03      [17]  119 	call player_update
   0559 CD EB 02      [17]  120 	call frisbee_update
                            121 
                            122 	;; Draw entities
   055C CD 18 04      [17]  123 	call player_draw
   055F CD 06 03      [17]  124 	call frisbee_draw
                            125 
   0562 18 E9         [12]  126 	jr (game_loop) 			;; Bucle infinito
   0564 C9            [10]  127 	ret
