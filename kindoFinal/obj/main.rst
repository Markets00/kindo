...
Hexadecimal [16-Bits]
                             ...
                             14 ;; ========================
   4EC1                      15 _main::
   4EC1 31 00 80      [10]   16 	ld 	sp, #0x8000 			;; Set stack pointer to 8000 to enable double buffer
                             17 
   4EC4 CD B3 6E      [17]   18 	call cpct_disableFirmware_asm  ;; Disable the firmware
   4EC7 CD 5F 5D      [17]   19 	call setPaletteBlackM1			;; Sets the palette to black on mode 1.
                             20 
   4ECA CD 8B 59      [17]   21 	call menuStart
   4ECD CD 33 60      [17]   22 	call gameStart		;; inicia una partida con los valores de game_data
                             23 
   4ED0 18 EF         [12]   24 	jr (_main)
