...
.macro defineEntity name, x,y, h, w, vx, vy, ax, ay, normal, sprites_ptr, id
	name'_data::
		...
		name'_last_x:	.db #30		;; Last x rendered		(8 bits)
		name'_erase_x:	.db #30		;; x rendered at same buffer	(8 bits)
		name'_last_y:	.db #30		;; Last y rendered		(8 bits)
		name'_erase_y:	.db #30		;; y rendered at same buffer	(8 bits)
