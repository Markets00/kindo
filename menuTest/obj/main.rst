...
Hexadecimal [16-Bits]
                             ...
                             14 ;; ========================
   0C49                      15 _main::
   0C49 31 00 80      [10]   16 	ld 	sp, #0x8000 			;; Set stack pointer to 8000 to enable double buffer
                             17 
   0C4C CD A6 18      [17]   18 	call cpct_disableFirmware_asm  ;; Disable the firmware
   0C4F CD 7E 0E      [17]   19 	call menuStart
   0C52 CD F1 0E      [17]   20 	call gameStart		;; inicia una partida con los valores de game_data
                             21 
                             22 	;;jr (_main)
